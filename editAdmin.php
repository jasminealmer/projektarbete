<!DOCTYPE html>
 <html lang="en" dir="ltr">
   ...
   <body>
     <div class="wrapper">
     <form class="form-signin" method="post" action="saveEditAdmin.php">
       <br/>
       <h2 class="form-signin-heading">Ändra uppgifter</h2>
       <?php
       include("connection.php");

       $userID_function = $_POST['edit_userID'];

       $query1 = "SELECT userTypeID FROM users WHERE userID=$userID_function";
       $result1 = $connection->query($query1);
       $userTypeID = $result1->fetch_assoc();
       $print_userTypeID = $userTypeID['userTypeID'];
       ...
       echo "<form method='post' action='saveEditAdmin.php'>
              <input type='hidden' value=".$userID_function." name='edit_userID'>
              <p>Användartyp:</p>
              <textarea rows='1' type='text' class='form-control' name='update_userTypeName'>$print_userTypeID</textarea>
              <p>Email:</p>
